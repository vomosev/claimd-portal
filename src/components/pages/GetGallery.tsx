  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        {!loading && images.length === 0 && <div className="text-center py-20 text-gray-500 text-lg">Couldn't find any Drop Memories. Go to the 'View Drop Memories' section on the previous page.</div>}
      </div>
      ...
      {selectedImage && (
        ...
        <button 
        onClick={handleCloseModal}
        className="hidden md:block absolute top-4 right-4 z-[110] text-white hover:text-gray-300 bg-black/50 hover:bg-black/70 rounded-full p-2 transition-all"
        aria-label="Close"
        >
            ...
            >
              ...
              <div className="flex items-center gap-3 p-4 border-b dark:border-gray-700 flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500">{timeAgo(selectedImage.timestamp)}</p>
                </div>
                  <button 
                    onClick={handleCloseModal}
