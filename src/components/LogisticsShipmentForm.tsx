    ...
    <div className="flex flex-col items-center justify-center min-h-[400px] space-y-6 py-12">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          {stopCount} stop{stopCount !== 1 ? "s" : ""} added to the booking.
        </p>
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
        <div>
          <h1 className="text-xl font-semibold flex items-center gap-2.5">
            ...
            {mode === "add"
              ? "New Booking"
              : `Edit Booking — SHP-${String(shipmentId).padStart(6, "0")}`
            }
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            {mode === "add"
              ? "Create a booking and add all stops in sequence order."
              : "Update booking details and stops."
            }
          </p>
        </div>
        {shipmentId && (
            ...
            >
              {saving ? (
                <>
                  ...
                  {mode === "add" ? "Creating Booking…" : "Updating Booking…"}
                </>
              ) : (
                <>
