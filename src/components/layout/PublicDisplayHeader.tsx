// src/components/layout/PublicDisplayHeader.tsx
"use client";
...
const PublicHeader = ({
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      const searchRoute = "/public/search";
  ...
  return (
    <header
      className={`fixed top-0 right-0 left-0 bg-gray-50 dark:bg-[#0A1223]  z-50 h-16 transition-all duration-300 ${
